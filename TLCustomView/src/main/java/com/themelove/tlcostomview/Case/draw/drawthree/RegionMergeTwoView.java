...
public class RegionMergeTwoView extends View {
    public RegionMergeTwoView(Context context) {
        this(context,null);
    }

    public RegionMergeTwoView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RegionMergeTwoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("替换Op.REPLACE",0,400,paint);
        ...
        canvas.drawText("翻转补集Op.REVERSE_DIFFERENCE",400,400,paint);
    }
