...
public class RegionMergeThreeView extends View {
    public RegionMergeThreeView(Context context) {
        this(context,null);
    }

    public RegionMergeThreeView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RegionMergeThreeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("并集Op.UNION",0,400,paint);
        ...
        canvas.drawText("异并集Op.XOR",400,400,paint);
    }
