...
public class TileMode_CLAMP_View extends View{
    private Context mContext;
    private Bitmap  mShaderBitmap;
    private Paint   mPaint;
    public TileMode_CLAMP_View(Context context) {
        this(context,null);
    }

    public TileMode_CLAMP_View(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TileMode_CLAMP_View(Context context, AttributeSet attrs, int defStyleAttr) {
